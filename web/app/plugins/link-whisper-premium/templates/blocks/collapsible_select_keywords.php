<div class="wpil-collapsible-wrapper" <?php echo Wpil_Toolbox::output_dropdown_wrapper_atts($data); ?>>
    <div class="wpil-collapsible wpil-collapsible-static wpil-links-count <?php echo (!empty($possible_links)) ? 'wpil-collapsible-has-data': 'wpil-collapsible-no-data';?>"><?=$total_possible_links?></div>
    ...
    <div class="insert-selected-autolinks">
        <div style="display:inline-block">
            <input id="select-all-possible-<?php echo $item->id; ?>" type="checkbox" class="wpil-select-all-possible-keywords" data-keyword-id="<?php echo $item->id; ?>"><label for="select-all-possible-<?php echo $item->id; ?>"><b><?php esc_html_e('Select All', 'wpil'); ?></b></label>
        </div>
        <a href="#" class="button-primary wpil-insert-selected-keywords" data-nonce="<?php echo wp_create_nonce(get_current_user_id() . 'insert-selected-autolinks-' . $post->id); ?>" data-post-id="<?php echo $post->id; ?>"  data-selected-link-id="<?php echo $post->id; ?>"><?php esc_html_e('Create Links', 'wpil'); ?></a>
    </div>
    <?php } ?>
</div>
