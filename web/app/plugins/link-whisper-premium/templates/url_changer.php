<div class="wrap wpil-report-page wpil_styles">
    ...
    <h1 class="wp-heading-inline"><?php esc_html_e('URL Changer','wpil'); ?></h1>
        ...
        <div id="post-body" class="metabox-holder">
            <div id="post-body-content" style="position: relative;">
                ...
                <div id="wpil_url_changer_table">
                    ...
                    <a href="javascript:void(0)" class="button-primary" id="wpil_url_changer_reset_button"><?php esc_html_e('Refresh Changed URL Report', 'wpil'); ?></a>
                    <?php if (!$reset) : ?>
                        <div class="table">
                            <?php $table->display(); ?>
                        </div>
