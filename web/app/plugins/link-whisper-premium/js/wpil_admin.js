...
/*
        ...
        var autolinkCheck = null;
        function runLinkInsertCheck(firstRun = false){
            ...
            clearTimeout(autolinkCheck);

            $.ajax({
                type: "POST",
                url: ajaxurl,
                data: {
                    action: 'wpil_run_autolink_insert_search',
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    ...
                    if(globalDashboardAutolinkCreate.error_count < 5){
                        autolinkCheck = setTimeout(runLinkInsertCheck, 10000);
                    }else{
                        var wrapper = document.createElement('div');
                        $(wrapper).append('<strong>' + textStatus + '</strong><br>');
                        $(wrapper).append(jqXHR.responseText);
                ...
                success: function(response){
                    ...
                    if(response.data){
                        ...
                        $('.wpil-dashboard-processing-autolinks-inserted').html(response.data.link_inserts);
