...
(function ($)
{
    ...
    function toggleShowTopAISuggestions(){
        ...
        if(usingAI){
            $('.wpil-show-top-ai-suggestions, .wpil-disable-ai-anchor-building').removeClass('hide-setting');
        }else{
            $('.wpil-show-top-ai-suggestions, .wpil-disable-ai-anchor-building').addClass('hide-setting');
        }
    }
...
//        $('.' + tabId).addClass('show-setting');
    ...
    $(document).on('change', '[name=wpil_limit_autolinks_to_post_types]', toggleAutolinkPostTypes);

    function toggleAutolinkPostTypes(e){
        if(undefined === e.target || undefined === e.target.name){
            return;
        }

        var autolinkPTs = $('.wpil-autolink-post-type-limit-setting');

        if($(e.target).is(':checked')){
            autolinkPTs.removeClass('hide-setting');
        }else{
            autolinkPTs.removeClass('hide-setting').addClass('hide-setting');
        }
    }
