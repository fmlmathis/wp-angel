        ...
        if(self::$json_data){
            ...
            if(!empty($data)){
                ...
                if(self::$post_saving){
                    ...
                    update_post_meta($post_id, $oxy_prefix . 'builder_json', addslashes($data));
                    update_post_meta($post_id, $oxy_prefix . 'builder_shortcodes', $shortcodes);
                }
            }
            ...
            update_post_meta($post_id, $oxy_prefix . 'builder_shortcodes', $text);
        }
    }
