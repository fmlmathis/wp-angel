...
define('WPIL_PLUGIN_VERSION_NUMBER', '2.5.7'); // todo remember to update with each new release
define('WPIL_PLUGIN_OLD_VERSION_NUMBER', '2.5.6'); // and only update when the new release is ready so testing downloads don't miss updates
...
define('WPIL_STATUS_PLUGIN_DB_VERSION', '1.41');  // simple version counter that gets incremented when we change the existing DB tables. That way update_tables knows when and what to update.
